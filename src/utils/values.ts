...
// Rewards Feature
export const listRewardsMessage = rewards =>
  `Team Rewards:${rewards.map(
    r => ` ${r}`
  )}. For info about a reward, use !info <reward>`
export const attemptRedeemRewardMessage = `Pleae use the !redeem command to redeem team rewards with your awesomeness. :)`

// Song Queue Reward
export const songQueueNoSongMessage = `Please provide a song title. :)`
